...
export default function Home() {
  const projects = [
    {
      ...
      tag: "Web • GDes 2342",
      href: "/projects/rstuning-website",
      img: "/images/rstuning-website/hero.jpg",
    },
    {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      {/* Hero */}
      <section className="max-w-6xl mx-auto px-6 pt-28 pb-14">
        ...
        <div className="mt-8 flex gap-3">
          <a href="/Alani-Nguyen-Resume.pdf" className="rounded-2xl border px-4 py-2">Resume</a>
          <a href="mailto:alaninguyen@email.com" className="rounded-2xl bg-white text-black px-4 py-2">Contact</a>
        </div>
      </section>
